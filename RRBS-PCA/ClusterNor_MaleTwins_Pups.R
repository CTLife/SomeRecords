...
# inputDir =  "11B_splitXY/100A-rmXY/2_cov20reads"
# myOutDir =  "1011B_splitXY/100A-rmXY/2_cov20reads/Cluster_MaleTwins_Pups"
...
MyPCA_1 <- function( mymeth1 ,  path1, file1, width1, height1, sdThres1 ) {   
  pdf( file=paste(path1, file1, sep="/") , width=width1, height=height1  )
...
MyPCA_2 <- function( mymeth1 ,  path1, file1, width1, height1, sdThres1 ) {   
  pdf( file=paste(path1, file1, sep="/") , width=width1, height=height1  )
...
MyPCA_3 <- function(  mymeth2 ,  path2,   file2, width2, height2 ) {
  MyPCA_1(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".ByQuantile.1A.kept100percent.pdf", sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0   )                     
  MyPCA_1(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".ByQuantile.1B.kept90percent.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.1 )                    
  MyPCA_1(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".ByQuantile.1C.kept80percent.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.2 )                    
  MyPCA_1(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".ByQuantile.1D.kept70percent.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.3 )                    
  MyPCA_1(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".ByQuantile.1E.kept60percent.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.4 )                    
  MyPCA_1(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".ByQuantile.1F.kept50percent.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.5 )                    
  MyPCA_1(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".ByQuantile.1G.kept40percent.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.6 )                    
  MyPCA_1(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".ByQuantile.1H.kept30percent.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.7 )                    
  MyPCA_1(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".ByQuantile.1I.kept20percent.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.8 )                    
  MyPCA_1(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".ByQuantile.1J.kept10percent.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.9 )                    
  MyPCA_1(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".ByQuantile.1K.kept5percent.pdf",   sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.95)                    
  MyPCA_1(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".ByQuantile.1L.kept1percent.pdf",   sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.99)                    
  
  MyPCA_2(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".NoQuantile.2A.sd0.pdf",     sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0   )                     
  MyPCA_2(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".NoQuantile.2B.sd0.01.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.01 )                    
  MyPCA_2(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".NoQuantile.2C.sd0.03.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.03 )                    
  MyPCA_2(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".NoQuantile.2D.sd0.05.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.05 )                    
  MyPCA_2(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".NoQuantile.2E.sd0.08.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.08 )                    
  MyPCA_2(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".NoQuantile.2F.sd0.10.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.10 )                    
  MyPCA_2(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".NoQuantile.2G.sd0.12.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.12 )                    
  MyPCA_2(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".NoQuantile.2H.sd0.15.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.15 )                    
  MyPCA_2(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".NoQuantile.2I.sd0.18.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.18 )                    
  MyPCA_2(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".NoQuantile.2J.sd0.20.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.20 )                    
  MyPCA_2(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".NoQuantile.2K.sd0.25.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.25)                    
  MyPCA_2(  mymeth1 = mymeth2 ,   path1 = path2, file1 = paste(file2, ".NoQuantile.2L.sd0.30.pdf",  sep=""),   width1 = width2,   height1 = height2,   sdThres1 = 0.30)                    
}




MyPCA_2 <- function(  mat2,   path2,   file2  ) {
  PCA1 <- prcomp( t(mat2)  )
  print( names(PCA1) )
...
######################################################################################################################################################
######################################################################################################################################################
myOutDir_2two = paste(myOutDir, "/2A-NC-vs-IVFfresh-2kbBin-1site",  sep="");
...
tiles_2two = tileMethylCounts( myobj_2two,   win.size=2000,   step.size=2000,   cov.bases = 1  )   ## 2kb bin
meth_2two  = unite( tiles_2two, destrand=FALSE, mc.cores=16   )   ## 100% overlap
mat_2two   = percMethylation( meth_2two )


sink( file=paste(myOutDir_2two , "2-dimensions-tiles.txt", sep="/")  )
print( tiles_2two )
print("#########dimensions:")
print( dim(meth_2two)  )   
print( dim(mat_2two)   )
...
pdf( file=paste(myOutDir_2two, "4A-MethylationStats-tiles.pdf", sep="/")  )
for( i in c(1:length(myobj_2two)) ) {
  getMethylationStats(tiles_2two[[i]], plot=TRUE, both.strands=FALSE )
}
dev.off()

sink( file=paste(myOutDir_2two, "4B-MethylationStats-tiles.txt", sep="/")  )
for( i in c(1:length(myobj_2two)) ) {
  print("##############################################")
  print( paste(mySampleID_All[i],  ":", sep="") )
...
pdf( file=paste(myOutDir_2two, "5A-CoverageStats-tiles.pdf", sep="/")  )
for( i in c(1:length(myobj_2two)) ) {
  getCoverageStats(tiles_2two[[i]], plot=TRUE, both.strands=FALSE )
}
dev.off()
sink( file=paste(myOutDir_2two, "5B-CoverageStats-tiles.txt", sep="/")  )
for( i in c(1:length(myobj_2two)) ) {
  print("##############################################")
  print( paste(mySampleID_All[i],   ":", sep="") )
...
pdf( file=paste(myOutDir_2two, "6A-Correlation-tiles.pdf", sep="/")  )
  getCorrelation(meth_2two, method = "pearson",   plot=TRUE  )
  getCorrelation(meth_2two, method = "spearman",  plot=TRUE  )
dev.off()

sink( file=paste(myOutDir_2two, "6B-pearsonCorrelation-tiles.txt", sep="/")  )
   getCorrelation(meth_2two, method = "pearson",   plot=FALSE  )
sink()

sink( file=paste(myOutDir_2two, "6C-spearmanCorrelation-tiles.txt", sep="/")  )
...
MyCluster_3(  mymeth2=meth_2two ,  path2=myOutDir_2two,   
              file2="7-cluster",   width2=8,   height2=5 )


MyPCA_3(  mymeth2=meth_2two ,  path2=myOutDir_2two,   
          file2="8-PCA",   width2=5,   height2=5 )





MyPCA_4(  mat2=mat_2two_sub2_2kb,   path2=myOutDir_2two,   file2="5-PCA"  )
