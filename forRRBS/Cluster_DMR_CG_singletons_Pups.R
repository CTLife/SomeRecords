...
# outDir_g   =  "1011B_splitXY/100A-rmXY/0_cov5reads/Cluster_DMR_CG_singletons_Pups"
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/12A-3_NC_vs_IVF_1kb_3bases",  sep="") ,   
                       binSize_temp1 = 1000,   binBases_temp1 = 3, dataFrame_temp1 = dataFrame_temp12_A  )
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/12A-5_NC_vs_IVF_1kb_5bases",  sep="") ,   
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/13A-3_NC_vs_ICSI_1kb_3bases",  sep="") ,   
                       binSize_temp1 = 1000,   binBases_temp1 = 3, dataFrame_temp1 = dataFrame_temp13_A  )
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/13A-5_NC_vs_ICSI_1kb_5bases",  sep="") ,   
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/14A-3_NC_vs_fresh_1kb_3bases",  sep="") ,   
                       binSize_temp1 = 1000,   binBases_temp1 = 3, dataFrame_temp1 = dataFrame_temp14_A  )
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/14A-5_NC_vs_fresh_1kb_5bases",  sep="") ,   
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/15A-3_NC_vs_frozen_1kb_3bases",  sep="") ,   
                       binSize_temp1 = 1000,   binBases_temp1 = 3, dataFrame_temp1 = dataFrame_temp15_A  )
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/15A-5_NC_vs_frozen_1kb_5bases",  sep="") ,   
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/16A-3_NC_vs_ART_1kb_3bases",  sep="") ,   
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/17A-3_IVF_vs_ICSI_1kb_3bases",  sep="") ,   
                       binSize_temp1 = 1000,   binBases_temp1 = 3, dataFrame_temp1 = dataFrame_temp17_A  )
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/17A-5_IVF_vs_ICSI_1kb_5bases",  sep="") ,   
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/18A-3_fresh_vs_frozen_1kb_3bases",  sep="") ,   
                       binSize_temp1 = 1000,   binBases_temp1 = 3, dataFrame_temp1 = dataFrame_temp18_A  )
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/18A-5_fresh_vs_frozen_1kb_5bases",  sep="") ,   
