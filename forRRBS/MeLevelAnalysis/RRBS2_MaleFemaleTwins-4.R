...
paste(inputDir, "8_W845C-girl-ICSI-frozen_Rep1.bismark.cov" ,   sep="/"),
paste(inputDir, "8_W845D-girl-ICSI-frozen_Rep1.bismark.cov" ,   sep="/")  
...
"NC7", "NC8", "NC9",  "NC10",  
"ICSI-frozen1", "ICSI-frozen2", "ICSI-frozen3",  "ICSI-frozen4" 
)
...
rep( c("boy"=16),  times=2 ) , 
rep( c("girl"=17), times=2 )  
) 
myType2_shape2 =  c( "boy"=16,  "girl"=17 )  


myType3        = c( rep(x="NC", times=10) , rep(x="ICSI-frozen", times=4) )
myType3_color  = c( rep( c("NC"="black"), times=10) , rep( c("ICSI-frozen"="green"), times=4) )
myType3_color2 = c("NC"="black" ,  "ICSI-frozen"="green")
