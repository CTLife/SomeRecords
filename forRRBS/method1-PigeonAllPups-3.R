...
paste(inputDir, "20_W1191D-ICSI-fresh-merge_Rep1.bismark.cov",  sep="/"),
paste(inputDir, "21_W1507C-ICSI-fresh_Rep1.bismark.cov",  sep="/"),
paste(inputDir, "22_W1636C-ICSI-fresh_Rep1.bismark.cov",  sep="/")  , 

paste(inputDir, "20_W1191C-ICSI-fresh_Rep1.bismark.cov",    sep="/"),
paste(inputDir, "21_W1507D-ICSI-fresh_Rep1.bismark.cov",    sep="/"),
paste(inputDir, "22_W1636D-ICSI-fresh_Rep1.bismark.cov",    sep="/") 
...
myType1 <- c(
  ...
  "20B-7", "21B-8", "22B-9",   "20B-10",  "21G-11",  "22G-12"
)

myType2 =  c( rep(x="boy", times=3) , rep(x="girl", times=3) , rep(x="boy", times=3) ,  rep(x="girl", times=3) ) 
myType3 =  c( rep(x="NC" , times=6) , rep(x="ICSI-fresh", times=6) )
