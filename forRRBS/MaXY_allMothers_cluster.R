...
## Example:  
## Rscript  MaXY_allMothers_cluster.R     2-SplitXY/A-rmXY     2000A_MaXY_allMothers_cluster_rmXY   >     2000A_MaXY_allMothers_cluster_rmXY.runLog  2>&1     
...
# outDir_g   =  "2000D_MaXY_allMothers_cluster_onlyY"
print(inputDir_g)   
print(outDir_g)
...
Files_NC_g <- c(
paste( inputDir_g,   "PCOS_10_P10M-mother-PCOS_Rep1.CpG.bismark.cov",  sep="/" ),
paste( inputDir_g,   "PCOS_1_P1M-mother-PCOS_Rep1.CpG.bismark.cov",  sep="/" ),
paste( inputDir_g,   "PCOS_2_P2M-mother-PCOS_Rep1.CpG.bismark.cov",  sep="/" ),
paste( inputDir_g,   "PCOS_3_P3M-mother-PCOS_Rep1.CpG.bismark.cov",  sep="/" ),
paste( inputDir_g,   "PCOS_4_P4M-mother-PCOS_Rep1.CpG.bismark.cov",  sep="/" ),
paste( inputDir_g,   "PCOS_5_P5M-mother-PCOS_Rep1.CpG.bismark.cov",  sep="/" ),
paste( inputDir_g,   "PCOS_6_P6M-mother-PCOS_Rep1.CpG.bismark.cov",  sep="/" ),
paste( inputDir_g,   "PCOS_7_P7M-mother-PCOS_Rep1.CpG.bismark.cov",  sep="/" ),
paste( inputDir_g,   "PCOS_8_P8M-mother-PCOS_Rep1.CpG.bismark.cov",  sep="/" ),
paste( inputDir_g,   "PCOS_9_P9M-mother-PCOS_Rep1.CpG.bismark.cov",  sep="/" )
)
...
Files_IVF_fresh_g <- c(
  ...
  paste( inputDir_g,   "chenwei_13_E29M-mother-IVFfresh_Rep9.CpG.bismark.cov",  sep="/" ),
  paste( inputDir_g,   "chenwei_113_E101M-mother-IVFfresh_Rep9.CpG.bismark.cov",  sep="/" )
)
...
for(i in c(1:length(Sex_IVF_fresh_g)) ) {
  ...
  if(i>=0) { Sex_IVF_fresh_g[i] = "mother" }
}
...
for(i in c(1:length(Sex_IVF_frozen_g)) ) {
  ...
  if(i>=0) { Sex_IVF_frozen_g[i] = "mother" }
}
...
for(i in c(1:length(Sex_ICSI_fresh_g)) ) {
  ...
  if(i>=0) { Sex_ICSI_fresh_g[i] = "mother" }
}



Files_ICSI_frozen_g <- c(
paste( inputDir_g,   "EM_10_E10M-mother_Rep1.CpG.bismark.cov",  sep="/" ),
paste( inputDir_g,   "EM_1_E1M-mother_Rep1.CpG.bismark.cov",  sep="/" ),
paste( inputDir_g,   "EM_2_E2M-mother_Rep1.CpG.bismark.cov",  sep="/" ),
#paste( inputDir_g,   "EM_3_E3M-mother_Rep1.CpG.bismark.cov",  sep="/" ),
paste( inputDir_g,   "EM_4_E4M-mother_Rep1.CpG.bismark.cov",  sep="/" ),
paste( inputDir_g,   "EM_5_E5M-mother_Rep1.CpG.bismark.cov",  sep="/" ),
#paste( inputDir_g,   "EM_6_E6M-mother_Rep1.CpG.bismark.cov",  sep="/" ),
paste( inputDir_g,   "EM_8_E8M-mother_Rep1.CpG.bismark.cov",  sep="/" ),
paste( inputDir_g,   "EM_9_E9M-mother_Rep1.CpG.bismark.cov",  sep="/" ) 
...
for(i in c(1:length(Sex_ICSI_frozen_g)) ) {
  ...
  if(i>=0) { Sex_ICSI_frozen_g[i] = "mother" }
}
