...
myHierarchicalClustering_1_g  <- function(  mat_3three,   path_temp1,   dataFrame_temp1  )  {
  ...
  fviz_dist(res.dist1_3three,  gradient = list(low = "#00AFBB", mid = "white", high = "#FC4E07")) 
  fviz_dist(res.dist2_3three,  gradient = list(low = "#00AFBB", mid = "white", high = "#FC4E07")) 
  fviz_dist(res.dist3_3three,  gradient = list(low = "#00AFBB", mid = "white", high = "#FC4E07")) 
  fviz_dist(res.dist4_3three,  gradient = list(low = "#00AFBB", mid = "white", high = "#FC4E07")) 
  fviz_dist(res.dist5_3three,  gradient = list(low = "#00AFBB", mid = "white", high = "#FC4E07")) 
  fviz_dist(res.dist6_3three,  gradient = list(low = "#00AFBB", mid = "white", high = "#FC4E07")) 
  fviz_dist(res.dist7_3three,  gradient = list(low = "#00AFBB", mid = "white", high = "#FC4E07")) 
  fviz_dist(res.dist8_3three,  gradient = list(low = "#00AFBB", mid = "white", high = "#FC4E07")) 
  dev.off() 
  ...
  fviz_dend(res.hc1_3three,   type="rectangle", main="ward.D, euclidean"  )
  fviz_dend(res.hc2_3three,   type="rectangle", main="ward.D, maximum"    )
  fviz_dend(res.hc3_3three,   type="rectangle", main="ward.D, manhattan"  )
  fviz_dend(res.hc4_3three,   type="rectangle", main="ward.D, canberra"   )
  fviz_dend(res.hc5_3three,   type="rectangle", main="ward.D, binary"     )
  fviz_dend(res.hc6_3three,   type="rectangle", main="ward.D, minkowski"  )
  fviz_dend(res.hc7_3three,   type="rectangle", main="ward.D, pearson"    )
  fviz_dend(res.hc8_3three,   type="rectangle", main="ward.D, spearman"   )
  dev.off() 
  
  pdf( file = paste(path_temp1, "2B_hierarchical-ward.D-phylogenic.pdf",  sep="/") )
  fviz_dend(res.hc1_3three,   type="phylogenic", main="ward.D, euclidean"  , repel = TRUE)
  fviz_dend(res.hc2_3three,   type="phylogenic", main="ward.D, maximum"    , repel = TRUE)
  fviz_dend(res.hc3_3three,   type="phylogenic", main="ward.D, manhattan"  , repel = TRUE)
  fviz_dend(res.hc4_3three,   type="phylogenic", main="ward.D, canberra"   , repel = TRUE)
  fviz_dend(res.hc5_3three,   type="phylogenic", main="ward.D, binary"     , repel = TRUE)
  fviz_dend(res.hc6_3three,   type="phylogenic", main="ward.D, minkowski"  , repel = TRUE)
  fviz_dend(res.hc7_3three,   type="phylogenic", main="ward.D, pearson"    , repel = TRUE)
  fviz_dend(res.hc8_3three,   type="phylogenic", main="ward.D, spearman"   , repel = TRUE)          
  dev.off() 
  ...
  fviz_dend(res.hc1_3three,   type="rectangle", main="ward.D2, euclidean"  )
  fviz_dend(res.hc2_3three,   type="rectangle", main="ward.D2, maximum"    )
  fviz_dend(res.hc3_3three,   type="rectangle", main="ward.D2, manhattan"  )
  fviz_dend(res.hc4_3three,   type="rectangle", main="ward.D2, canberra"   )
  fviz_dend(res.hc5_3three,   type="rectangle", main="ward.D2, binary"     )
  fviz_dend(res.hc6_3three,   type="rectangle", main="ward.D2, minkowski"  )
  fviz_dend(res.hc7_3three,   type="rectangle", main="ward.D2, pearson"    )
  fviz_dend(res.hc8_3three,   type="rectangle", main="ward.D2, spearman"   )
  dev.off() 
  
  pdf( file = paste(path_temp1, "3B_hierarchical-ward.D2-phylogenic.pdf",  sep="/") )
  fviz_dend(res.hc1_3three,   type="phylogenic", main="ward.D2, euclidean"  , repel = TRUE)
  fviz_dend(res.hc2_3three,   type="phylogenic", main="ward.D2, maximum"    , repel = TRUE)
  fviz_dend(res.hc3_3three,   type="phylogenic", main="ward.D2, manhattan"  , repel = TRUE)
  fviz_dend(res.hc4_3three,   type="phylogenic", main="ward.D2, canberra"   , repel = TRUE)
  fviz_dend(res.hc5_3three,   type="phylogenic", main="ward.D2, binary"     , repel = TRUE)
  fviz_dend(res.hc6_3three,   type="phylogenic", main="ward.D2, minkowski"  , repel = TRUE)
  fviz_dend(res.hc7_3three,   type="phylogenic", main="ward.D2, pearson"    , repel = TRUE)
  fviz_dend(res.hc8_3three,   type="phylogenic", main="ward.D2, spearman"   , repel = TRUE)          
  dev.off() 
  ...
  fviz_dend(res.hc1_3three,   type="rectangle", main="single, euclidean"  )
  fviz_dend(res.hc2_3three,   type="rectangle", main="single, maximum"    )
  fviz_dend(res.hc3_3three,   type="rectangle", main="single, manhattan"  )
  fviz_dend(res.hc4_3three,   type="rectangle", main="single, canberra"   )
  fviz_dend(res.hc5_3three,   type="rectangle", main="single, binary"     )
  fviz_dend(res.hc6_3three,   type="rectangle", main="single, minkowski"  )
  fviz_dend(res.hc7_3three,   type="rectangle", main="single, pearson"    )
  fviz_dend(res.hc8_3three,   type="rectangle", main="single, spearman"   )
  dev.off() 
  
  pdf( file = paste(path_temp1, "4B_hierarchical-single-phylogenic.pdf",  sep="/") )
  fviz_dend(res.hc1_3three,   type="phylogenic", main="single, euclidean"  , repel = TRUE)
  fviz_dend(res.hc2_3three,   type="phylogenic", main="single, maximum"    , repel = TRUE)
  fviz_dend(res.hc3_3three,   type="phylogenic", main="single, manhattan"  , repel = TRUE)
  fviz_dend(res.hc4_3three,   type="phylogenic", main="single, canberra"   , repel = TRUE)
  fviz_dend(res.hc5_3three,   type="phylogenic", main="single, binary"     , repel = TRUE)
  fviz_dend(res.hc6_3three,   type="phylogenic", main="single, minkowski"  , repel = TRUE)
  fviz_dend(res.hc7_3three,   type="phylogenic", main="single, pearson"    , repel = TRUE)
  fviz_dend(res.hc8_3three,   type="phylogenic", main="single, spearman"   , repel = TRUE)          
  dev.off() 
  ...
  fviz_dend(res.hc1_3three,   type="rectangle", main="complete, euclidean"  )
  fviz_dend(res.hc2_3three,   type="rectangle", main="complete, maximum"    )
  fviz_dend(res.hc3_3three,   type="rectangle", main="complete, manhattan"  )
  fviz_dend(res.hc4_3three,   type="rectangle", main="complete, canberra"   )
  fviz_dend(res.hc5_3three,   type="rectangle", main="complete, binary"     )
  fviz_dend(res.hc6_3three,   type="rectangle", main="complete, minkowski"  )
  fviz_dend(res.hc7_3three,   type="rectangle", main="complete, pearson"    )
  fviz_dend(res.hc8_3three,   type="rectangle", main="complete, spearman"   )
  dev.off() 
  
  pdf( file = paste(path_temp1, "5B_hierarchical-complete-phylogenic.pdf",  sep="/") )
  fviz_dend(res.hc1_3three,   type="phylogenic", main="complete, euclidean"  , repel = TRUE)
  fviz_dend(res.hc2_3three,   type="phylogenic", main="complete, maximum"    , repel = TRUE)
  fviz_dend(res.hc3_3three,   type="phylogenic", main="complete, manhattan"  , repel = TRUE)
  fviz_dend(res.hc4_3three,   type="phylogenic", main="complete, canberra"   , repel = TRUE)
  fviz_dend(res.hc5_3three,   type="phylogenic", main="complete, binary"     , repel = TRUE)
  fviz_dend(res.hc6_3three,   type="phylogenic", main="complete, minkowski"  , repel = TRUE)
  fviz_dend(res.hc7_3three,   type="phylogenic", main="complete, pearson"    , repel = TRUE)
  fviz_dend(res.hc8_3three,   type="phylogenic", main="complete, spearman"   , repel = TRUE)          
  dev.off() 
  ...
  fviz_dend(res.hc1_3three,   type="rectangle", main="average, euclidean"  )
  fviz_dend(res.hc2_3three,   type="rectangle", main="average, maximum"    )
  fviz_dend(res.hc3_3three,   type="rectangle", main="average, manhattan"  )
  fviz_dend(res.hc4_3three,   type="rectangle", main="average, canberra"   )
  fviz_dend(res.hc5_3three,   type="rectangle", main="average, binary"     )
  fviz_dend(res.hc6_3three,   type="rectangle", main="average, minkowski"  )
  fviz_dend(res.hc7_3three,   type="rectangle", main="average, pearson"    )
  fviz_dend(res.hc8_3three,   type="rectangle", main="average, spearman"   )
  dev.off() 
  
  pdf( file = paste(path_temp1, "6B_hierarchical-average-phylogenic.pdf",  sep="/") )
  fviz_dend(res.hc1_3three,   type="phylogenic", main="average, euclidean"  , repel = TRUE)
  fviz_dend(res.hc2_3three,   type="phylogenic", main="average, maximum"    , repel = TRUE)
  fviz_dend(res.hc3_3three,   type="phylogenic", main="average, manhattan"  , repel = TRUE)
  fviz_dend(res.hc4_3three,   type="phylogenic", main="average, canberra"   , repel = TRUE)
  fviz_dend(res.hc5_3three,   type="phylogenic", main="average, binary"     , repel = TRUE)
  fviz_dend(res.hc6_3three,   type="phylogenic", main="average, minkowski"  , repel = TRUE)
  fviz_dend(res.hc7_3three,   type="phylogenic", main="average, pearson"    , repel = TRUE)
  fviz_dend(res.hc8_3three,   type="phylogenic", main="average, spearman"   , repel = TRUE)          
  dev.off() 
  ...
  fviz_dend(res.hc1_3three,   type="rectangle", main="mcquitty, euclidean"  )
  fviz_dend(res.hc2_3three,   type="rectangle", main="mcquitty, maximum"    )
  fviz_dend(res.hc3_3three,   type="rectangle", main="mcquitty, manhattan"  )
  fviz_dend(res.hc4_3three,   type="rectangle", main="mcquitty, canberra"   )
  fviz_dend(res.hc5_3three,   type="rectangle", main="mcquitty, binary"     )
  fviz_dend(res.hc6_3three,   type="rectangle", main="mcquitty, minkowski"  )
  fviz_dend(res.hc7_3three,   type="rectangle", main="mcquitty, pearson"    )
  fviz_dend(res.hc8_3three,   type="rectangle", main="mcquitty, spearman"   )
  dev.off() 
  
  pdf( file = paste(path_temp1, "7B_hierarchical-mcquitty-phylogenic.pdf",  sep="/") )
  fviz_dend(res.hc1_3three,   type="phylogenic", main="mcquitty, euclidean"  , repel = TRUE)
  fviz_dend(res.hc2_3three,   type="phylogenic", main="mcquitty, maximum"    , repel = TRUE)
  fviz_dend(res.hc3_3three,   type="phylogenic", main="mcquitty, manhattan"  , repel = TRUE)
  fviz_dend(res.hc4_3three,   type="phylogenic", main="mcquitty, canberra"   , repel = TRUE)
  fviz_dend(res.hc5_3three,   type="phylogenic", main="mcquitty, binary"     , repel = TRUE)
  fviz_dend(res.hc6_3three,   type="phylogenic", main="mcquitty, minkowski"  , repel = TRUE)
  fviz_dend(res.hc7_3three,   type="phylogenic", main="mcquitty, pearson"    , repel = TRUE)
  fviz_dend(res.hc8_3three,   type="phylogenic", main="mcquitty, spearman"   , repel = TRUE)          
  dev.off() 
  ...
  fviz_dend(res.hc1_3three,   type="rectangle", main="median, euclidean"  )
  fviz_dend(res.hc2_3three,   type="rectangle", main="median, maximum"    )
  fviz_dend(res.hc3_3three,   type="rectangle", main="median, manhattan"  )
  fviz_dend(res.hc4_3three,   type="rectangle", main="median, canberra"   )
  fviz_dend(res.hc5_3three,   type="rectangle", main="median, binary"     )
  fviz_dend(res.hc6_3three,   type="rectangle", main="median, minkowski"  )
  fviz_dend(res.hc7_3three,   type="rectangle", main="median, pearson"    )
  fviz_dend(res.hc8_3three,   type="rectangle", main="median, spearman"   )
  dev.off() 
  
  pdf( file = paste(path_temp1, "8B_hierarchical-median-phylogenic.pdf",  sep="/") )
  fviz_dend(res.hc1_3three,   type="phylogenic", main="median, euclidean"  , repel = TRUE)
  fviz_dend(res.hc2_3three,   type="phylogenic", main="median, maximum"    , repel = TRUE)
  fviz_dend(res.hc3_3three,   type="phylogenic", main="median, manhattan"  , repel = TRUE)
  fviz_dend(res.hc4_3three,   type="phylogenic", main="median, canberra"   , repel = TRUE)
  fviz_dend(res.hc5_3three,   type="phylogenic", main="median, binary"     , repel = TRUE)
  fviz_dend(res.hc6_3three,   type="phylogenic", main="median, minkowski"  , repel = TRUE)
  fviz_dend(res.hc7_3three,   type="phylogenic", main="median, pearson"    , repel = TRUE)
  fviz_dend(res.hc8_3three,   type="phylogenic", main="median, spearman"   , repel = TRUE)          
  dev.off() 
  ...
  fviz_dend(res.hc1_3three,   type="rectangle", main="centroid, euclidean"  )
  fviz_dend(res.hc2_3three,   type="rectangle", main="centroid, maximum"    )
  fviz_dend(res.hc3_3three,   type="rectangle", main="centroid, manhattan"  )
  fviz_dend(res.hc4_3three,   type="rectangle", main="centroid, canberra"   )
  fviz_dend(res.hc5_3three,   type="rectangle", main="centroid, binary"     )
  fviz_dend(res.hc6_3three,   type="rectangle", main="centroid, minkowski"  )
  fviz_dend(res.hc7_3three,   type="rectangle", main="centroid, pearson"    )
  fviz_dend(res.hc8_3three,   type="rectangle", main="centroid, spearman"   )
  dev.off() 
  
  pdf( file = paste(path_temp1, "9B_hierarchical-centroid-phylogenic.pdf",  sep="/") )
  fviz_dend(res.hc1_3three,   type="phylogenic", main="centroid, euclidean"  , repel = TRUE)
  fviz_dend(res.hc2_3three,   type="phylogenic", main="centroid, maximum"    , repel = TRUE)
  fviz_dend(res.hc3_3three,   type="phylogenic", main="centroid, manhattan"  , repel = TRUE)
  fviz_dend(res.hc4_3three,   type="phylogenic", main="centroid, canberra"   , repel = TRUE)
  fviz_dend(res.hc5_3three,   type="phylogenic", main="centroid, binary"     , repel = TRUE)
  fviz_dend(res.hc6_3three,   type="phylogenic", main="centroid, minkowski"  , repel = TRUE)
  fviz_dend(res.hc7_3three,   type="phylogenic", main="centroid, pearson"    , repel = TRUE)
  fviz_dend(res.hc8_3three,   type="phylogenic", main="centroid, spearman"   , repel = TRUE)          
  dev.off() 
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/2A-1_NC-vs-IVFfresh_2kb_1bases",  sep="") ,   
                       binSize_temp1 = 2000,   binBases_temp1 = 1, dataFrame_temp1 = dataFrame_temp1_A  )
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/2A-2_NC-vs-IVFfresh_2kb_2bases",  sep="") ,   
                       binSize_temp1 = 2000,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp1_A  )
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/2A-3_NC-vs-IVFfresh_2kb_3bases",  sep="") ,   
                       binSize_temp1 = 2000,   binBases_temp1 = 3, dataFrame_temp1 = dataFrame_temp1_A  )
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/2A-4_NC-vs-IVFfresh_2kb_4bases",  sep="") ,   
                       binSize_temp1 = 2000,   binBases_temp1 = 4, dataFrame_temp1 = dataFrame_temp1_A  )
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/2A-5_NC-vs-IVFfresh_2kb_5bases",  sep="") ,   
                       binSize_temp1 = 2000,   binBases_temp1 = 5, dataFrame_temp1 = dataFrame_temp1_A  )
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/2A-10_NC-vs-IVFfresh_2kb_10bases",  sep="") ,   
                       binSize_temp1 = 2000,   binBases_temp1 = 10, dataFrame_temp1 = dataFrame_temp1_A  )
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/2A-20_NC-vs-IVFfresh_2kb_20bases",  sep="") ,   
                       binSize_temp1 = 2000,   binBases_temp1 = 20, dataFrame_temp1 = dataFrame_temp1_A  )
  
  
  ###
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/2B-1_NC-vs-IVFfresh_1kb_1bases",  sep="") ,   
                       binSize_temp1 = 1000,   binBases_temp1 = 1, dataFrame_temp1 = dataFrame_temp1_A  )
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/2B-2_NC-vs-IVFfresh_1kb_2bases",  sep="") ,   
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/2B-4_NC-vs-IVFfresh_1kb_4bases",  sep="") ,   
                       binSize_temp1 = 1000,   binBases_temp1 = 4, dataFrame_temp1 = dataFrame_temp1_A  )
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/2B-5_NC-vs-IVFfresh_1kb_5bases",  sep="") ,   
                       binSize_temp1 = 1000,   binBases_temp1 = 5, dataFrame_temp1 = dataFrame_temp1_A  )
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/2B-10_NC-vs-IVFfresh_1kb_10bases",  sep="") ,   
                       binSize_temp1 = 1000,   binBases_temp1 = 10, dataFrame_temp1 = dataFrame_temp1_A  )
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/2B-20_NC-vs-IVFfresh_1kb_20bases",  sep="") ,   
