...
paste(inputDir, "16_W839C-IVF-frozen_Rep1.bismark.cov", sep="/"),
paste(inputDir, "17_W1524D-IVF-frozen_Rep1.bismark.cov", sep="/"),
paste(inputDir, "18_W1387C-IVF-frozen_Rep1.bismark.cov" ,  sep="/"),
paste(inputDir, "19_W1458D-IVF-frozen_Rep1.bismark.cov" , sep="/")  ,

paste(inputDir, "16_W839D-IVF-frozen_Rep1.bismark.cov", sep="/"),
paste(inputDir, "17_Q24-W1524C-IVF-frozen_Rep1.bismark.cov", sep="/"),
paste(inputDir, "18_W1387D-IVF-frozen_Rep1.bismark.cov" , sep="/"), 
paste(inputDir, "19_W1458C-IVF-frozen_Rep1.bismark.cov", sep="/") 

)

mySampleID <- list( 
"NC1", "NC2",  "NC3",  "NC4", "NC5",  "NC6",  
"IVF-frozen1",  "IVF-frozen2", "IVF-frozen3", 
"IVF-frozen4",  "IVF-frozen5", "IVF-frozen6", 
"IVF-frozen7",  "IVF-frozen8"  
)
...
myType1 <- c(
  ...
  "16B-7", "17B-8", "18B-9",   "19B-10",  "16G-11",  "17G-12",   "18G-13",   "19G-14"  
)
