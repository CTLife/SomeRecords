...
paste(inputDir, "1_A42F-father-IVF-frozen_Rep1.bismark.cov" ,  sep="/"), 
paste(inputDir, "1_A42M-Mother-IVF-frozen_Rep1.bismark.cov" ,  sep="/"),
paste(inputDir, "2_W1785F-father-IVF-frozen_Rep1.bismark.cov" ,  sep="/"), 
paste(inputDir, "2_Q16-W1785M-mother-IVF-frozen_Rep1.bismark.cov" ,  sep="/"), 
paste(inputDir, "3_Q8-W811F-father-IVF-frozen_Rep1.bismark.cov" ,  sep="/"),
paste(inputDir, "3_Q2-W811M-mother-IVF-frozen_Rep1.bismark.cov" ,  sep="/"),
paste(inputDir, "4_W28F-father-IVF-frozen_Rep1.bismark.cov" ,  sep="/"), 
paste(inputDir, "4_W28M-Mother-IVF-frozen_Rep1.bismark.cov",  sep="/") 
)


mySampleID <- list( 
"NC1", "NC2",  "NC3", "NC4", "NC5", "NC6", 
"IVF-frozen1",  "IVF-frozen2", "IVF-frozen3",  "IVF-frozen4" , "IVF-frozen5", "IVF-frozen6" , "IVF-frozen7", "IVF-frozen8" 
)
...
myType2        = rep( c("father", "mother"),      times=7) 
myType2_shape  = rep( c("father"=1, "mother"=2),  times=7) 
myType2_shape2 =  c("father"=1, "mother"=2)  

myType3        = c( rep(x="NC", times=6) , rep(x="IVF-frozen", times=8) )
myType3_color  = c( rep( c("NC"="black"), times=6) , rep( c("IVF-frozen"="purple"), times=8) )
myType3_color2 = c("NC"="black" ,  "IVF-frozen"="purple")
