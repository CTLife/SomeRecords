...
## run this script, such as:  Rscript  RefSeq_mRNA_to_Symbol_mm10.R    DoulbleKOvsWT.down.txt    1    1
...
write.table(x=input.table, file = paste(file.name, "_symbol.txt", sep=""), append = FALSE, quote = FALSE, sep = "\t",
