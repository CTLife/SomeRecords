...
rawMatrix_1  <- read.table("noDups-peaks-genes-H3K27me3_within10kb",   header=TRUE,   sep="",   quote = "",   comment.char = "")  

dim(rawMatrix_1)  
rawMatrix_1[1:10,]


WT_oneClass <- ceiling( nrow(rawMatrix_1)/10 )
WT_oneClass
WT_oneClass2 <- nrow(rawMatrix_1) - WT_oneClass * 9
WT_oneClass2
WT_xAxis <-  c( rep("1", WT_oneClass),   rep("2", WT_oneClass), rep("3", WT_oneClass) ,   rep("4", WT_oneClass) ,  rep("5", WT_oneClass  ) ,
                rep("6", WT_oneClass),   rep("7", WT_oneClass), rep("8", WT_oneClass) ,   rep("9", WT_oneClass) ,  rep("910", WT_oneClass2  )  ) 
length(WT_xAxis)
nrow(rawMatrix_1)
...
MySaveGgplot2_1(ggplot2Figure1=FigureTemp1,  path1="z-figures", fileName1=paste("1-grouped-boxplot",   "byH3K27me3WT",  sep = "_"),  height1=4,  width1=10)
...
MySaveGgplot2_1(ggplot2Figure1=FigureTemp2,  path1="z-figures", fileName1=paste("2-grouped-boxplot-scatter",   "byH3K27me3WT",  sep = "_"),  height1=4,  width1=12)
...
FigureTemp2 <- ggplot(data = dataFrame_1, aes(x=class1,  y=H3K27me3, fill=type1, colour=type1)  ) +  ylim(0, 20) +
  geom_jitter( aes(colour=type1 ), size=0.1,  alpha=0.5, position = position_jitterdodge(jitter.width=0.7, dodge.width=0.9 )  ) +
  geom_boxplot( position=position_dodge(0.9), outlier.size=0 , alpha=0, colour="black"  ) + 
  MyTheme_1( hjust1=NULL, vjust1=NULL,  angle1=NULL,   textSize=14 ) 

MySaveGgplot2_1(ggplot2Figure1=FigureTemp2,  path1="z-figures", fileName1=paste("3-grouped-boxplot-scatter",   "byH3K27me3WT",  sep = "_"),  height1=4,  width1=12)
...
index_class5 <- c(Length_oneClass*4+1: Length_oneClass*5)
index_class6 <- c(Length_oneClass*5+1: Length_oneClass*6)
index_class7 <- c(Length_oneClass*6+1: Length_oneClass*7)
index_class8 <- c(Length_oneClass*7+1: Length_oneClass*8)
index_class9 <- c(Length_oneClass*8+1: Length_oneClass*9)
index_class10<- c(Length_oneClass*9+1: Length_oneClass*10)
...
MyHypothesisTest_1(vector1=rawMatrix_1[index_class5,3],  vector2=rawMatrix_1[index_class5,4],  file1=paste("z-figures",  "/5-class5-WT-vs-EEDko.unpaired.txt",     sep = "")   )  
MyHypothesisTest_1(vector1=rawMatrix_1[index_class6,3],  vector2=rawMatrix_1[index_class6,4],  file1=paste("z-figures",  "/6-class6-WT-vs-EEDko.unpaired.txt",     sep = "")   )  
MyHypothesisTest_1(vector1=rawMatrix_1[index_class7,3],  vector2=rawMatrix_1[index_class7,4],  file1=paste("z-figures",  "/7-class7-WT-vs-EEDko.unpaired.txt",     sep = "")   )  
MyHypothesisTest_1(vector1=rawMatrix_1[index_class8,3],  vector2=rawMatrix_1[index_class8,4],  file1=paste("z-figures",  "/8-class8-WT-vs-EEDko.unpaired.txt",     sep = "")   )  
MyHypothesisTest_1(vector1=rawMatrix_1[index_class9,3],  vector2=rawMatrix_1[index_class9,4],  file1=paste("z-figures",  "/9-class9-WT-vs-EEDko.unpaired.txt",     sep = "")   )  
MyHypothesisTest_1(vector1=rawMatrix_1[index_class10,3], vector2=rawMatrix_1[index_class10,4], file1=paste("z-figures",  "/10-class10-WT-vs-EEDko.unpaired.txt",   sep = "")   )  
