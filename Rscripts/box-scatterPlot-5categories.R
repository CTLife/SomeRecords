...
WT_oneClass <- ceiling( nrow(rawMatrix_1)/5 )
WT_oneClass
WT_oneClass2 <- nrow(rawMatrix_1) - WT_oneClass * 4
WT_oneClass2
WT_xAxis <-  c( rep("ALowest", WT_oneClass),   rep("BLow", WT_oneClass), rep("CMedium", WT_oneClass) ,   rep("DHigh", WT_oneClass) ,  rep("EHighest", WT_oneClass2  )  ) 
length(WT_xAxis)
nrow(rawMatrix_1)
...
MySaveGgplot2_1(ggplot2Figure1=FigureTemp1,  path1="z-figures", fileName1=paste("1-grouped-boxplot",   "byH3K27me3WT",  sep = "_"),  height1=4,  width1=6)
...
MySaveGgplot2_1(ggplot2Figure1=FigureTemp2,  path1="z-figures", fileName1=paste("2-grouped-boxplot-scatter",   "byH3K27me3WT",  sep = "_"),  height1=4,  width1=8)
...
MyHypothesisTest_2(vector1=rawMatrix_1[index_class5,3],  vector2=rawMatrix_1[index_class5,4],  file1=paste("z-figures",  "/A4-class4-WT-vs-EEDko.paired.txt",     sep = "")   )  
