...
FigureTemp2 <- ggplot(data = rawMatrix_3 , aes(x = class2,  y = log2(value), colour=class, group=class)  ) + geom_point() + geom_line() + 
  scale_x_discrete(limits= c("Lowest", "Low", "High", "Highest") ) + 
  scale_colour_manual( values=c("GATA4_spe"="purple2", "Nkx25_spe"="blue2", "GATA4_Nkx25_common"="red2" ) ) +
...
FigureTemp2 <- ggplot(data = rawMatrix_3 , aes(x = class2,  y = value, colour=class, group=class)  ) + geom_point() + geom_line() + 
  scale_x_discrete(limits= c("Lowest", "Low", "High", "Highest") ) + 
  scale_colour_manual( values=c("GATA4_spe"="purple2", "Nkx25_spe"="blue2", "GATA4_Nkx25_common"="red2") ) +
  MyTheme_1( hjust1=NULL, vjust1=NULL,  angle1=NULL,   textSize=14 ) 
