...
###################################################################################################################################################################################################
my $input_g  = '';  ## such as "2-bamCoverage/H3K4me3"
my $output_g = '';  ## such as "3-subtractInput/H3K4me3"
...
my $HELP = '
        ...
        Usage:
               perl  2-bigwigCompare.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]
        For instance:
               perl  2-bigwigCompare.pl    -in 2-bamCoverage/H3K4me3   -out 3-subtractInput/H3K4me3    > 2-bigwigCompare.H3K4me3.runLog  2>&1 
...
## Version Infromation
my $version = " version 0.1,  2019-10-30.";
...
$input_g  = '2-bamCoverage/H3K4me3';       ## This is only an initialization value or suggesting value, not default value.
$output_g = '3-subtractInput/H3K4me3';     ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  2-bigwigCompare.pl  -help' \n";
    exit 0;
}
...
my $input2_g = $input_g;
$input2_g =~ s/H3K4me1/Input/;
$input2_g =~ s/H3K4me3/Input/;
$input2_g =~ s/H3K27me3/Input/;
$input2_g =~ s/H3K27ac/Input/;
...
for ( my $i=0; $i<=$#inputFiles_g; $i++ ) {
        ...
        $temp =~ s/.bw$//  or  die;
	my $temp2 = $temp;
	$temp2 =~ s/H3K4me1/Input/;
	$temp2 =~ s/H3K4me3/Input/;
	$temp2 =~ s/H3K27me3/Input/;
	$temp2 =~ s/H3K27ac/Input/;   
        system("bigwigCompare   --bigwig1 $input_g/$temp.bw  --bigwig2 $input2_g/$temp2.bw    --operation subtract    --binSize 50   --verbose  --outFileName $output_g/$temp.bw     --outFileFormat bigwig   > $output_g/$temp.runLog.txt  2>&1  ");                                                  
}
