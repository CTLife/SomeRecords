...
my $output_g = '';  ## such as "2-bedGraph/H3K4me3"
...
my $HELP = '
        ...
        Usage:
               perl  bigWigToBedGraph.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]
        For instance:
               perl  bigWigToBedGraph.pl    -in 2-bamCoverage/H3K4me3   -out 2-bedGraph/H3K4me3    > bigWigToBedGraph.H3K4me3.runLog  2>&1 
...
$output_g = '2-bedGraph/H3K4me3';       ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  bigWigToBedGraph.pl  -help' \n";
    exit 0;
}
...
for ( my $i=0; $i<=$#inputFiles_g; $i++ ) {
        ...
        $temp =~ s/.bw$//  or  die;
        system(" bigWigToBedGraph   $input_g/$temp.bw     $output_g/$temp.bg  > $output_g/$temp.runLog.txt  2>&1  ");                                                  
}
