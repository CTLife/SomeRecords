...
outDir_g = "Results_Kmeans_6clusters_2"
...
results_1 = kmeans(x=rawMatrix_3, centers=6, iter.max = 1000, nstart =25)
...
results_1_cluster_index = c(    which(results_1_cluster==1), which(results_1_cluster==5), 
