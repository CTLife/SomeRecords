...
###########################################################################################################################################################################
df_1 <- read.table("R22317154-library34-S-293T/abundance.tsv",  header=T,   sep="\t" )  
df_2 <- read.table("R22317155-library35-T-1/abundance.tsv",     header=T,   sep="\t" )  
df_3 <- read.table("R22317156-library36-T-2/abundance.tsv",     header=T,   sep="\t" )  
df_4 <- read.table("R22317157-library37-CD/abundance.tsv",      header=T,   sep="\t" )  
df_5 <- read.table("R22317773-library39-F-T-1/abundance.tsv",   header=T,   sep="\t" )  
df_6 <- read.table("R22317774-library40-F-T-2/abundance.tsv",   header=T,   sep="\t" )  
