...
###########################################################################################################################################################################
df_1 <- read.table("R22314099-2022120610-2022120610/abundance.tsv",  header=T,   sep="\t" )  
df_2 <- read.table("R22314100-2022120615-2022120615/abundance.tsv",     header=T,   sep="\t" )  
df_3 <- read.table("R22317735-20221221t7VN-20221221t7VN/abundance.tsv",     header=T,   sep="\t" )  
...
matrix1 = log2( cbind( TPM_1, TPM_2, TPM_3  ) + 1)
matrix1[1:5, ]
