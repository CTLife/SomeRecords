...
#################################################
rawMatrix_1 <- read.table("encode_tfbs.txt", header=TRUE, sep="\t", quote = "", comment.char = "") 
...
MyHeatmaps_1_original(matrix2=rawMatrix_1,  path2=outPath,   fileName2="1.heatmap.pdf",  height2=15,   width2=8, is.corr2=FALSE,   my_col2=my_col1(1000)  )

MyHeatmaps_2_f(matrix2=rawMatrix_1,  path2=outPath,   fileName2="2.heatmap.pdf",   height2=15,   width2=8 ) 


my_col2=colorRampPalette( c(   "green4", "green", "yellow",  "yellow4", "purple",  "purple4") , bias = 2)  
pdf( file=paste(outPath, "3.heatmap.pdf", sep="/"),  height=15,   width=8 )
...
pdf( file = paste(outPath, "4.heatmap.pdf", sep="/"),  width=15, height=8  )
...
pdf( file = paste(outPath, "5.heatmap.pdf", sep="/"),  width=15, height=8  )
print( corrplot(rawMatrix_1, method = "square", type = "full",  title = "", is.corr = FALSE,  order = "original",  tl.col = "black", tl.srt = 90, col = my_col3(1000) )  )  
dev.off() 
