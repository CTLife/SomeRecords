...
my $output_g = '';  ## such as "4a_log2ratio"
...
my $HELP = '
        ...
        ------------------------------------------------------------------------------------------------------------------------------------------------------     
        Usage:
               perl 4a_log2ratio.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]      
        For instance:
               nohup time  perl 4a_log2ratio.pl   -in 3_quan   -out 4a_log2ratio     > 4a_log2ratio.runLog.txt  2>&1    &
...
$output_g = '4a_log2ratio';    ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl 4a_log2ratio.pl  -help' \n";
    exit 0;
}
...
for ( my $i=0; $i<=$#inputFiles_g; $i++ ) {
        ...
        for (my $j=1; $j<=$#lines1; $j++) {
            ...
            $chr1 = "chr".$chr1;
            $chr2 = "chr".$chr2;
            my $score = log2( ($fpkm1+0.00001)/($fpkm2+0.00001) );
