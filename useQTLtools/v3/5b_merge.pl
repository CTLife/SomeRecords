...
###################################################################################################################################################################################################
my $input_g  = '';  ## such as "4b_minusInput"   
my $output_g = '';  ## such as "5b_merge"
...
my $HELP = '
        ...
        ------------------------------------------------------------------------------------------------------------------------------------------------------     
        Usage:
               perl 5b_merge.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]      
        For instance:
               nohup time  perl 5b_merge.pl   -in 4b_minusInput   -out 5b_merge     > 5b_merge.runLog.txt  2>&1    &
...
$input_g  = '4b_minusInput';         ## This is only an initialization value or suggesting value, not default value.
$output_g = '5b_merge';              ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl 5b_merge.pl  -help' \n";
    exit 0;
}
