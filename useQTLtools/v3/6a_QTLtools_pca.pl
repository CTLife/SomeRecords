...
###################################################################################################################################################################################################
my $input_g  = '';  ## such as "5a_merge"   
my $output_g = '';  ## such as "6a_QTLtools_pca"
...
my $HELP = '
        ...
        ------------------------------------------------------------------------------------------------------------------------------------------------------     
        Usage:
               perl 6a_QTLtools_pca.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]      
        For instance:
               nohup time  perl 6a_QTLtools_pca.pl   -in 5a_merge   -out 6a_pca     > 6a_QTLtools_pca.runLog.txt  2>&1    &
...
$input_g  = '5a_merge';            ## This is only an initialization value or suggesting value, not default value.
$output_g = '6a_QTLtools_pca';     ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl 6a_QTLtools_pca.pl  -help' \n";
    exit 0;
}
