...
my $output_g = '';  ## such as "4_minusInput"
...
my $HELP = '
        ...
        ------------------------------------------------------------------------------------------------------------------------------------------------------     
        Usage:
               perl 4_minusInput.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]      
        For instance:
               nohup time  perl 4_minusInput.pl   -in 3_quan   -out 4_minusInput     > 4_minusInput.runLog.txt  2>&1    &
...
$output_g = '4_minusInput';    ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl 4_minusInput.pl  -help' \n";
    exit 0;
}
