...
###################################################################################################################################################################################################
my $input_g  = '';  ## such as "4_minusInput"   
my $output_g = '';  ## such as "5_merge"
...
my $HELP = '
        ...
        ------------------------------------------------------------------------------------------------------------------------------------------------------     
        Usage:
               perl 5_merge.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]      
        For instance:
               nohup time  perl 5_merge.pl   -in 4_minusInput   -out 5_merge     > 5_merge.runLog.txt  2>&1    &
...
$input_g  = '4_minusInput';          ## This is only an initialization value or suggesting value, not default value.
$output_g = '5_merge';               ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl 5_merge.pl  -help' \n";
    exit 0;
}
