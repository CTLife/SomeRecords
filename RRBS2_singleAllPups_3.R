...
vec_2two_strength  <-  as.numeric(vec_2two_values) 
length(vec_2two_strength[vec_2two_strength<20])
length(vec_2two_strength[(vec_2two_strength>=20) & (vec_2two_strength<=80)])
length(vec_2two_strength[vec_2two_strength>80])

myLow_2two_a  <-  c( vec_2two_strength<20 )  
myMedium_2two_a  <-  c( (vec_2two_strength>=20) & (vec_2two_strength<=80) )
myHigh_2two_a  <-  c( vec_2two_strength>80 )

length(vec_2two_values)
length(myLow_2two_a)
length(myMedium_2two_a)
length(myHigh_2two_a)


vec_2two_strength[myLow_2two_a] <- "1Low"
vec_2two_strength[myMedium_2two_a] <- "2Medium"
vec_2two_strength[myHigh_2two_a] <- "3High"

length(vec_2two_strength)
